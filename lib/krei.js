...
/***/ (function(module, exports) {
	 ...
	 */
	var Krei = exports.Krei = function Krei() {
	  _classCallCheck(this, Krei);
	};

	var KreiPlugin = exports.KreiPlugin = function () {
	  function KreiPlugin() {
	    _classCallCheck(this, KreiPlugin);
	  }

	  _createClass(KreiPlugin, [{
	    key: "description",
